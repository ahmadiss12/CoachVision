...
from .reference_angles import (
    BICEP_ELBOW_EXTENDED_DEG,
    BICEP_ELBOW_FULL_CURL_DEG,
    BICEP_BUFFER_DEG,
)
...
class BicepCurlConfig(RepCounterConfig):
    ...
    """
    extension_threshold: float = BICEP_ELBOW_EXTENDED_DEG
    flexion_threshold: float = BICEP_ELBOW_FULL_CURL_DEG
    
    buffer: float = BICEP_BUFFER_DEG
