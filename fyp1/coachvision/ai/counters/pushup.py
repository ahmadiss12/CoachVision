...
from .reference_angles import PUSHUP_ELBOW_PARALLEL_TARGET_DEG, PUSHUP_PRESET_BUFFER
...
class PushUpConfig(RepCounterConfig):
    ...
    """
    # Angle thresholds (in degrees) — bottom target from reference_angles (ACSM-aligned ~90° elbow)
    extension_threshold: float = 160.0
    flexion_threshold: float = PUSHUP_ELBOW_PARALLEL_TARGET_DEG
    
    buffer: float = PUSHUP_PRESET_BUFFER["intermediate"]
