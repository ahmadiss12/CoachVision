...
from .reference_angles import (
    SQUAT_PRESET_FLEXION,
    SQUAT_PRESET_BUFFER,
    PUSHUP_PRESET_FLEXION,
    PUSHUP_PRESET_BUFFER,
    LUNGE_PRESET_FLEXION,
    LUNGE_PRESET_BUFFER,
...
# Configuration presets — flexion/buffer values from reference_angles (ACSM-aligned literature)
CONFIG_PRESETS = {
    "beginner": {
        "squat": {
            "flexion_threshold": SQUAT_PRESET_FLEXION["beginner"],
            "buffer": SQUAT_PRESET_BUFFER["beginner"],
        },
        "pushup": {
            "flexion_threshold": PUSHUP_PRESET_FLEXION["beginner"],
            "buffer": PUSHUP_PRESET_BUFFER["beginner"],
        },
        "lunge": {
            "flexion_threshold": LUNGE_PRESET_FLEXION["beginner"],
            "buffer": LUNGE_PRESET_BUFFER["beginner"],
        },
        "deadlift": {
            "flexion_threshold": DEADLIFT_PRESET_FLEXION["beginner"],
            "buffer": DEADLIFT_PRESET_BUFFER["beginner"],
        },
        "plank": {"min_hold_time": 5},
        "wall_sit": {"min_hold_time": 5},
    },
    "intermediate": {
        "squat": {
            "flexion_threshold": SQUAT_PRESET_FLEXION["intermediate"],
            "buffer": SQUAT_PRESET_BUFFER["intermediate"],
        },
        "pushup": {
            "flexion_threshold": PUSHUP_PRESET_FLEXION["intermediate"],
            "buffer": PUSHUP_PRESET_BUFFER["intermediate"],
        },
        "lunge": {
            "flexion_threshold": LUNGE_PRESET_FLEXION["intermediate"],
            "buffer": LUNGE_PRESET_BUFFER["intermediate"],
        },
        "deadlift": {
            "flexion_threshold": DEADLIFT_PRESET_FLEXION["intermediate"],
            "buffer": DEADLIFT_PRESET_BUFFER["intermediate"],
        },
    ...
    "advanced": {
        "squat": {
            "flexion_threshold": SQUAT_PRESET_FLEXION["advanced"],
            "buffer": SQUAT_PRESET_BUFFER["advanced"],
        },
        "pushup": {
            "flexion_threshold": PUSHUP_PRESET_FLEXION["advanced"],
            "buffer": PUSHUP_PRESET_BUFFER["advanced"],
        },
        "lunge": {
            "flexion_threshold": LUNGE_PRESET_FLEXION["advanced"],
            "buffer": LUNGE_PRESET_BUFFER["advanced"],
        },
        "deadlift": {
            "flexion_threshold": DEADLIFT_PRESET_FLEXION["advanced"],
            "buffer": DEADLIFT_PRESET_BUFFER["advanced"],
        },
