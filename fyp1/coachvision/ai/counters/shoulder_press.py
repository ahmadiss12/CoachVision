...
from .reference_angles import (
    SHOULDER_PRESS_ELBOW_OVERHEAD_DEG,
    SHOULDER_PRESS_ELBOW_START_DEG,
    SHOULDER_PRESS_BUFFER_DEG,
)
...
class ShoulderPressConfig(RepCounterConfig):
    ...
    """
    extension_threshold: float = SHOULDER_PRESS_ELBOW_OVERHEAD_DEG
    flexion_threshold: float = SHOULDER_PRESS_ELBOW_START_DEG
    
    buffer: float = SHOULDER_PRESS_BUFFER_DEG
