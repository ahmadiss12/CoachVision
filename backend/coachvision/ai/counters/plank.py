...
from .reference_angles import (
    ...
    PLANK_BODY_LINE_WARNING_DEG,
    PLANK_MIN_HOLD_SEC,
    PLANK_GOOD_HOLD_SEC,
    PLANK_EXCELLENT_HOLD_SEC,
)
...
class PlankConfig(RepCounterConfig):
    ...
    """
    angle_threshold: float = PLANK_BODY_LINE_MIN_DEG
    angle_warning_threshold: float = PLANK_BODY_LINE_WARNING_DEG
    
    min_hold_time: float = PLANK_MIN_HOLD_SEC
    good_hold_time: float = PLANK_GOOD_HOLD_SEC
    excellent_hold_time: float = PLANK_EXCELLENT_HOLD_SEC
