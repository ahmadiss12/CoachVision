...
from .reference_angles import DEADLIFT_PRESET_FLEXION, DEADLIFT_PRESET_BUFFER
...
class DeadliftConfig(RepCounterConfig):
    ...
    """
    # Angle thresholds (in degrees) — defaults match intermediate preset in reference_angles
    extension_threshold: float = 165.0
    flexion_threshold: float = DEADLIFT_PRESET_FLEXION["intermediate"]
    
    buffer: float = DEADLIFT_PRESET_BUFFER["intermediate"]
