...
from .reference_angles import (
    HIGH_KNEES_HIP_FLEXION_DEG,
    HIGH_KNEES_HIP_EXTENSION_DEG,
    HIGH_KNEES_BUFFER_DEG,
)
...
class HighKneesConfig(RepCounterConfig):
    ...
    hip_flexion_threshold: float = HIGH_KNEES_HIP_FLEXION_DEG
    hip_extension_threshold: float = HIGH_KNEES_HIP_EXTENSION_DEG
    
    arm_drive_threshold: float = 0.1
    
    buffer: float = HIGH_KNEES_BUFFER_DEG
