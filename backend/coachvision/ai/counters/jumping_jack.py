...
from .reference_angles import (
    JUMPING_JACK_ARM_STRAIGHT_DEG,
    JUMPING_JACK_ARM_ABDUCTION_DEG,
    JUMPING_JACK_LEG_STRAIGHT_DEG,
    JUMPING_JACK_FEET_APART_NORM,
    JUMPING_JACK_FEET_TOGETHER_NORM,
    JUMPING_JACK_ARM_OVERHEAD_NORM,
    JUMPING_JACK_POSITION_BUFFER_NORM,
    JUMPING_JACK_COORDINATION_NORM,
)
...
class JumpingJackConfig(RepCounterConfig):
    ...
    """
    arm_extension_threshold: float = JUMPING_JACK_ARM_STRAIGHT_DEG
    arm_abduction_threshold: float = JUMPING_JACK_ARM_ABDUCTION_DEG
    
    leg_straight_threshold: float = JUMPING_JACK_LEG_STRAIGHT_DEG
    
    feet_apart_threshold: float = JUMPING_JACK_FEET_APART_NORM
    feet_together_threshold: float = JUMPING_JACK_FEET_TOGETHER_NORM
    
    arm_overhead_threshold: float = JUMPING_JACK_ARM_OVERHEAD_NORM
    
    buffer: float = JUMPING_JACK_POSITION_BUFFER_NORM
    
    angle_buffer_size: int = 3
    
    coordination_threshold: float = JUMPING_JACK_COORDINATION_NORM
