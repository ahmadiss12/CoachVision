...
from .reference_angles import (
    LUNGE_EXTENSION_STANDING_DEG,
    LUNGE_FLEXION_BOTTOM_INTERMEDIATE_DEG,
    LUNGE_DEFAULT_BUFFER_DEG,
    LUNGE_TOO_SHALLOW_DEG,
    LUNGE_TOO_DEEP_DEG,
    LUNGE_REAR_KNEE_TARGET_DEG,
    LUNGE_REAR_KNEE_TOLERANCE_DEG,
)
...
class LungeConfig(RepCounterConfig):
    ...
    """
    # Angle thresholds (in degrees) — see reference_angles.py
    extension_threshold: float = LUNGE_EXTENSION_STANDING_DEG
    flexion_threshold: float = LUNGE_FLEXION_BOTTOM_INTERMEDIATE_DEG
    
    buffer: float = LUNGE_DEFAULT_BUFFER_DEG
    
    angle_buffer_size: int = 3
    
    too_shallow_angle: float = LUNGE_TOO_SHALLOW_DEG
    too_deep_angle: float = LUNGE_TOO_DEEP_DEG
    ...
    rear_knee_target: float = LUNGE_REAR_KNEE_TARGET_DEG
    rear_knee_tolerance: float = LUNGE_REAR_KNEE_TOLERANCE_DEG
