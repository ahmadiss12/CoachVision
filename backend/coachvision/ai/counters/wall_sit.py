...
from .reference_angles import (
    WALL_SIT_KNEE_TARGET_DEG,
    WALL_SIT_KNEE_TOLERANCE_DEG,
    WALL_SIT_BACK_TARGET_DEG,
    WALL_SIT_BACK_TOLERANCE_DEG,
    WALL_SIT_MIN_HOLD_SEC,
    WALL_SIT_GOOD_HOLD_SEC,
    WALL_SIT_EXCELLENT_HOLD_SEC,
)
...
class WallSitConfig(RepCounterConfig):
    ...
    """
    knee_angle_target: float = WALL_SIT_KNEE_TARGET_DEG
    knee_angle_tolerance: float = WALL_SIT_KNEE_TOLERANCE_DEG
    
    back_angle_target: float = WALL_SIT_BACK_TARGET_DEG
    back_angle_tolerance: float = WALL_SIT_BACK_TOLERANCE_DEG
    
    min_hold_time: float = WALL_SIT_MIN_HOLD_SEC
    good_hold_time: float = WALL_SIT_GOOD_HOLD_SEC
    excellent_hold_time: float = WALL_SIT_EXCELLENT_HOLD_SEC
