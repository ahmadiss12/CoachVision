...
from .reference_angles import (
    MOUNTAIN_CLIMBER_PLANK_MIN_DEG,
    MOUNTAIN_CLIMBER_KNEE_DRIVE_DEG,
    MOUNTAIN_CLIMBER_KNEE_EXTENDED_DEG,
    MOUNTAIN_CLIMBER_BUFFER_DEG,
)
...
class MountainClimberConfig(RepCounterConfig):
    ...
    """
    plank_angle_threshold: float = MOUNTAIN_CLIMBER_PLANK_MIN_DEG
    
    knee_drive_threshold: float = MOUNTAIN_CLIMBER_KNEE_DRIVE_DEG
    knee_start_threshold: float = MOUNTAIN_CLIMBER_KNEE_EXTENDED_DEG
    
    buffer: float = MOUNTAIN_CLIMBER_BUFFER_DEG
